...
namespace SoldierCommand {
	class ModConfig {
		...
		public void ReadConfig(ICoreAPI api) {
			...
			api.World.Config.SetString("NameWhitelist", config.NameWhitelist);
			api.World.Config.SetString("NameBlacklist", config.NameBlacklist);
		}
	...
	class SoldierConfig {
		...
		public string NameWhitelist { get; set; }
		public string NameBlacklist { get; set; }
		...
		public SoldierConfig(SoldierConfig prev) {
			...
			NameWhitelist = prev.NameWhitelist;
			NameBlacklist = prev.NameBlacklist;
		}
	}
}